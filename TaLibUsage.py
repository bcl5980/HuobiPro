...
#copy from https://www.cnblogs.com/hhh5460/p/5602357.html

parser = argparse.ArgumentParser(description='TaLibUsage')
parser.add_argument('--file', default='eosusdt_1min_1000.json')
args = parser.parse_args()

series,ts = hw.get_kfromjson(ls.load_k(args.file))
